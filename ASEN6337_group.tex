...
%% --- Title and Authors --- %% 
\title{Understanding Clouds from Satellite Images \large
        \\ Group: Why So Cirrus? \\ ASEN 6337 Group Project Report  \\ Fall '24}
\author[1]{J. Monaco}
\author[1]{Maggie Zheng}
\author[1]{Kawther Rouabhi}
\author[1]{AJ Cuddeback}
\affil[1]{CU Boulder Smead Aerospace}
...
\maketitle
\begin{abstract}
    \textbf{Abstract}: \textit{A concise (200 words or fewer) summary of the paper.}
\end{abstract}
\tableofcontents
\newpage
